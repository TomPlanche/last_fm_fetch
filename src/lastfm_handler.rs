...
impl LastFMHandler {
    ...
    pub async fn get_user_loved_tracks(
        ...
        let mut all_tracks: Vec<LovedTrack> = Vec::new();
        ...
        let initial_response: UserLovedTracks =
            self.fetch("user.getlovedtracks", &base_params).await?;
        let total_tracks = initial_response.lovedtracks.attr.total;
        ...
        if actual_limit > API_MAX_LIMIT {
            ...
            for i in 0..needed_chunks {
                ...
                for j in 0..CHUNK_MULTIPLIER {
                    ...
                    let fetch = async move {
                        self.fetch::<UserLovedTracks>("user.getlovedtracks", &params)
                            .await
                    };
                ...
                for result in chunk_results {
                    ...
                    match result {
                        Ok(tracks) => all_tracks.extend(tracks.lovedtracks.track),
            ...
            all_tracks.extend(response.lovedtracks.track);
        }
